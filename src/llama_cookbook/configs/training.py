...
class train_config:
    ...
    # model_name: str="meta-llama/Meta-Llama-3.1-8B" # updated 2025/03/19 for taming.
    model_name: str="meta-llama/Llama-3.2-1B" # updated 2025/03/19 for taming - a smaller one!  
    ...
    batch_size_training: int=4  # ** reduce from 4 to save memory?
    batching_strategy: str="packing" #alternative: padding
    context_length: int=1024 # ** reduced from 4096 to save memory
    gradient_accumulation_steps: int=16 # ** increased from 1 to accomondate smaller batch size
    ...
    output_dir: str = "peft_saved/model"
    ...
    dist_checkpoint_root_folder: str="fsdp_saved/model" # will be used if using FSDP
    ...
    profiler_dir: str = "profile_saved/results" # will be used if using profiler
